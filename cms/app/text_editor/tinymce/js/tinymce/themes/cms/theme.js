...
tinymce.ThemeManager.add('cms', function(editor) {
	...
	var defaultMenus = {
		...
		format: {title: 'Format', items: 'b_cms i_cms underline strikethrough superscript subscript | formats | removeformat'},
		table: {title: 'Table'},
		tools: {title: 'Tools'}
	};
   
	var defaultToolbar = "b_cms i_cms  link_cms image email media_cms media_cms_em | style1 style2 style3 | bullist_cms numlist_cms | align_left  align_center align_right |  code_cms";
