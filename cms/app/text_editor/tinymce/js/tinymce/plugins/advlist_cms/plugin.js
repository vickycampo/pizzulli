...
tinymce.PluginManager.add('advlist_cms', function(editor, url) {
	...
	editor.addButton('numlist_cms', {
		type: 'button',
		tooltip: 'NUMBERED LIST',
                                    image : url + '/_text_button_OL.png',
		//menu: olMenuItems,
	...
	editor.addButton('bullist_cms', {
		type: 'button',
		tooltip: 'BULLET LIST',
                                    image : url + '/_text_button_UL.png',
		//menu: ulMenuItems,
		//onshow: updateSelection,
		//onselect: function(e) {
